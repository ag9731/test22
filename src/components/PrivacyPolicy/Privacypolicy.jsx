...
const Privacypolicy = () => {
  return (
    <div className="container mx-auto mt-[5%]">
      ...
      <p className="mt-5 ">Last updated: March 19, 2025</p>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Parvi Digital Solutions.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Parvi Digital Solutions,
            accessible from{" "}
            <a
      ...
      <ul>
        ...
        <li>
          <p>By phone number: 9380128840</p>
        </li>
      </ul>
    </div>
  );
